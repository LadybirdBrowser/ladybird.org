...
With support of this property we can now accurately render the relatively complex "torch effect" on null.com, which is composed of `mask-image`, `background-clip`, and a radial gradient.
