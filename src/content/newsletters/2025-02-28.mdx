...
It's been a short but productive month for the Ladybird project! We've merged 281 PRs from 38 contributors, let's take a look at some of the highlights!
...
The low-hanging fruits are exhausted at this point, but the upward grind must continue.

For context, here is the last month's progress for all browsers:

![](/assets/img/newsletter-feb-2025-wpt-graph.gif)

And without 1.1 million legacy text encoding tests that bloat the score:

![](/assets/img/newsletter-feb-2025-wpt-graph-no-encoding.gif)
